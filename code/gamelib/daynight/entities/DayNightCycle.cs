...
namespace Gamelib.DayNight
{
    ...
    public class DayNightCycle : ModelEntity
	{
		...
		public override void Spawn()
		{
			...
			DawnSkyColor = new Color32( 160, 111, 5 ).ToColor();

			DayColor = Color.White;
			DaySkyColor = Color.White;

			DuskColor = Color.White;
			DuskSkyColor = new Color32( 160, 56, 16 ).ToColor();

			NightColor = new Color32( 125, 125, 125 ).ToColor();
			NightSkyColor = new Color32( 6, 32, 161 ).ToColor();
